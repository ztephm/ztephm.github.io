export { Configuration, InitConfiguration, buildCookieOptions, validateAndBuildConfiguration, DefaultPrivacyLevel, EndpointBuilder, isExperimentalFeatureEnabled, updateExperimentalFeatures, resetExperimentalFeatures, isSimulationActive, getSimulationLabel, } from './domain/configuration';
...
export { startTelemetry, Telemetry, RawTelemetryEvent, addTelemetryDebug, addTelemetryError, startFakeTelemetry, resetTelemetry, TelemetryEvent, TelemetryErrorEvent, TelemetryDebugEvent, isTelemetryReplicationAllowed, } from './domain/telemetry';
